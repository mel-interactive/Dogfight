...
func enter():
	# Consume ultimate meter immediately
	character.ultimate_meter = 0
...
func update(delta):
	if sliding:
		...
		# Stronger deceleration curve for ultimate (ease-out)
...
func get_attack_sound() -> AudioStream:
	return character.character_data.ultimate_attack_sound

func get_attack_duration() -> float:
	return character.character_data.ultimate_attack_duration
